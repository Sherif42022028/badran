      ...
      <div className="framed-section p-5 sm:p-8 md:p-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-3.5 font-tajawal text-[#1A110B]">
            ...
            <p className="text-sm md:text-base leading-relaxed text-[#1A110B]/85 font-normal">
              تأسس <strong className="font-bold text-[#1A110B]">بن بدران</strong> ليكون الوجهة الأولى لعشاق القهوة الحقيقيين في ميت غمر والدقهلية. نحن نهتم بكل تفصيلة في القهوة: بدءاً من اختيار حبوب البن الخضراء الصافية، وحتى تحميصها وطحنها قدام عينك في المحل بالنسبة والتحويجة اللي تحبها.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2 text-xs md:text-sm font-semibold">
              <div className="flex items-center gap-2 bg-[#F7F4EF] p-3 rounded-lg border border-[#1A110B]/10">
